// this is a code for interacting with the UI and making sure everything is functional
...
login.addEventListener('click', function onClick() {
    if ((document.getElementById("username").value === "ndlovuraymond") && (document.getElementById("pass").value === "BlockBizRocks")) {
        ...
        userP = document.querySelector(".user-profile")
        userP.innerHTML = `<h1>Username: ndlovuraymond</h1>
        <h1>Name: Raymond Ndlovu</h1>
        <h1>Date of Account Creation: 2023/04/30</h1>
        <h1>Date of Birth: 2000/14/10</h1>`
    }
    else {
